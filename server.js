...
const PORT = process.env.PORT || 5000; // Use environment port or 3000 locally
app.listen(PORT, () => console.log(`Server running on port ${PORT}`));

// OR, more common for serverless:

module.exports = app; // If using Express, export the app instance.
                      // Vercel's Node builder often handles the listen part.